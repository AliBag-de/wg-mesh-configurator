...
export function Sidebar({
    ...
    return (
        <aside className={cn("flex flex-col h-screen border-r bg-card/50 backdrop-blur-xl", className)}>
            ...
            <div className="px-3 py-2 space-y-1 flex-1 overflow-y-auto custom-scrollbar">

                <button
                    onClick={() => toggleSection('gateways')}
                    className="w-full flex items-center justify-between text-[10px] font-bold text-muted-foreground uppercase tracking-widest mt-4 mb-1 px-2 hover:text-foreground transition-colors"
                >
